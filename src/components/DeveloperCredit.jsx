...
const DeveloperCredit = () => {
  return (
    <div className="w-full bg-gradient-to-r from-white via-[#f9f9f9] to-white py-10 px-4 mt-24 border-t border-gray-200">
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <p className="text-gray-800 text-sm sm:text-base leading-relaxed max-w-md">
          ...
          <a
            href="https://github.com/SatinderSinghSall?tab=repositories"
            target="_blank"
